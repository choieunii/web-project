...
<body>
 ...
 <div>                                
	<div class="container">
		<div class="row">
	<form id="insertFrm" name="insertFrm" action="<%=request.getContextPath()%>/board/movie_board_1_wtdb.jsp" method="post">
    <div>글제목 : </div>
    ...
    <div><br>
        <input type="button" value=" 글 입력 " onclick="javascript:Insert();"/>&nbsp;&nbsp;&nbsp;
        <input type="reset" value=" 초기화 "/>&nbsp;&nbsp;&nbsp;
        <input type="button" id="insertFrm" onclick="location.href='<%=request.getContextPath()%>/board/movie_board_1_list.jsp'" value=" 글 목록 ">
       </div>
</form>
		</div>
	</div>

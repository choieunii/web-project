...
if(request.getParameter("boardNo") == null || request.getParameter("boardPw") == null) {
    ...
    try {
        ...
        response.sendRedirect(request.getContextPath()+"/board/movie_board_1_view.jsp?boardNo="+boardNo);
        /*
        response.setContentType("text/html; charset=UTF-8");     
    	PrintWriter out1 = response.getWriter();	 
    	out1.println("<script>alert('계정이 등록 되었습니다'); location.href='movie_board_1_view.jsp';</script>");	 
    	out1.flush();
        */

...
if(request.getParameter("boardNo") == null) {
    response.sendRedirect(request.getContextPath()+"/board/movie_board_1_list.jsp");
} else {
...
<div>
    <a href="<%=request.getContextPath()%>/board/movie_board_1_md.jsp?boardNo=<%=boardNo%>">수정</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="<%=request.getContextPath()%>/board/movie_board_1_rm.jsp?boardNo=<%=boardNo%>">삭제</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="<%=request.getContextPath()%>/board/movie_board_1_list.jsp?boardNo=<%=boardNo%>">목록</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>

        ...
        <div class="container">
            <div class="row">
                <div class="movie">
                    ...
                    <form action="<%=request.getContextPath()%>/board/movie_board_main_ht.jsp" method="post">                   
                            ...
                            <div class="chart_cont1 swiper-wrapper">
                               	<div>
                                    ...
                                    <div class="infor">
                                        ...
                                        <div class="infor_btn">
                                            <a href="movie_board_2.jsp">상세보기</a>
                                            <a href="#">예매하기</a>
                                        </div>
                                    </div>
                               	</div>
                                ...
                                <div>
                                    ...
                                    <div class="infor">
                                        ...
                                        <div class="infor_btn">
                                            <a href="movie_board_3.jsp">상세보기</a>
                                            <a href="#">예매하기</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="infor">
                                        ...
                                        <div class="infor_btn">
                                            <a href="movie_board_4.jsp">상세보기</a>
                                            <a href="#">예매하기</a>
                                        </div>
                                    </div>
                               </div>    
                                <!-- </div> -->
                                  ...
                                  <br><center><input type="submit" value="좋아요 확인"></center>

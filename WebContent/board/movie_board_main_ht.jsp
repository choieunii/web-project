        ...
        <div class="banner_menu">
            <div class="container">
                <div class="row">
                    ...
                    <div class="bm_right">
                        <ul>
                            <li class="purple"><a href="#">로그인 </a></li>
                            <li class="purple"><a href="movie_board_main.html">영화 게시판</a></li>
                            <li class="purple"><a href="#">영화 예매</a></li>                                                    
                        </ul>
                    </div>
                </div>
            </div>
...
if(Integer.parseInt(request.getParameter("mv1"))==0&&Integer.parseInt(request.getParameter("mv2"))==0&&Integer.parseInt(request.getParameter("mv3"))==0&&Integer.parseInt(request.getParameter("mv4"))==0){
	response.sendRedirect(request.getContextPath()+"/board/movie_board_main.jsp");
}else{
...
<br>
<div>
    <a href="<%=request.getContextPath()%>/board/movie_board_main.jsp">다시하기</a>
    </div>
</center>
</div>

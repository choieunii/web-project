...
<tr>
    ...
    <td>
        <a href="<%=request.getContextPath()%>/movie_board_1_view.jsp?boardNo=<%=listResultSet.getInt("board_no")%>">
...
<%
        if(currentPage>1) {
%>
            <a href="<%=request.getContextPath()%>/movie_board_1_list.jsp?currentPage=<%=currentPage-1%>">이전</a>
<%
        }
        if(currentPage < lastPage) {
%>
 
            <a href="<%=request.getContextPath()%>/movie_board_1_list.jsp?currentPage=<%=currentPage+1%>">다음</a>
<%
        }
%>
    </div>
